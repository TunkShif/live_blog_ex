...
(function (root, factory) {
  ...
  function (root) {
    ...
    // Default options.
    var defaultOptions = require("tocbot/src/js/default-options.js");
    // Object to store current options.
    var options = {};
    // Object for public APIs.
    var tocbot = {};

    var BuildHtml = require("tocbot/src/js/build-html.js");
    var ParseContent = require("tocbot/src/js/parse-content.js");
    var updateTocScroll = require("tocbot/src/js/update-toc-scroll.js");
    ...
    tocbot.init = function (customOptions) {
      ...
      if (options.scrollSmooth) {
        ...
        tocbot.scrollSmooth =
          require("tocbot/src/js/scroll-smooth").initSmoothScrolling(options);
      }
